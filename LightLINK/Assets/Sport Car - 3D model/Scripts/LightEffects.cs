...
public class LightEffects : MonoBehaviour {
    ...
    private void Start()
    {
        FL = transform.Find("Lights/FrontLights").gameObject;
        BL = transform.Find("Lights/BrakeLights").gameObject;
        TL = transform.Find("Lights/TailLights").gameObject;
        RL = transform.Find("Lights/ReverseLights").gameObject;
        IL = transform.Find("Lights/LeftIndicators").gameObject;
        IR = transform.Find("Lights/RightIndicators").gameObject;
